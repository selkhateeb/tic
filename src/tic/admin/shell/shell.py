...
class FrontPageHandler(Component):
    """
    ...
    def match_request(self, req):
        """Documentation"""
        logging.debug(req.path_info)
        return re.search('^/admin/shell$', req.path_info)
...
class StatementHandler(Component):
    implements(IRequestHandler)
    """Evaluates a python statement in a given session and returns the result.
  """
    def match_request(self, req):
        """Documentation"""
        return re.search('^/admin/shell.do$', req.path_info)
    ...
    def process_request(self, req):
        ...
        session = Session.get(req.session)
